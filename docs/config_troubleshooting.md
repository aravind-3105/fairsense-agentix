...
1. Explicit arguments to `Settings(...)` (if you construct Settings in code)
2. Environment variables in your shell (`export FAIRSENSE_LLM_PROVIDER=openai`)
3. `.env` file values (`FAIRSENSE_LLM_PROVIDER=openai`)
4. Code defaults (`llm_provider="fake"`)
